...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    // If there are errors, show the first one and exit
    if (hasErrors) {
        toast.error(errorMessages[0]); // Show only the first error message
    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-white mt-10">
        <form
          ...
          className="w-full max-w-md px-6 py-6 rounded-lg shadow-xl border border-gray-200"
        >
