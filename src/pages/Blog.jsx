    ...
    <div className="w-full h-[316px] bg-[url('/assets/Blogbg.png')] bg-cover bg-center relative">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-10">
        <div className="flex flex-col items-center gap-4">
          {/* Add responsive title or content here if needed */}
        </div>
      </div>
    </div>

    {/* Main Content */}
    <div className="max-w-[1440px] mx-auto px-4 sm:px-8 md:px-16 lg:px-28 py-16">
      <div className="flex flex-col md:flex-row gap-10 relative">
          ...
          {blogPosts.map((post) => (
            <div key={post.id} className="bg-white">
              <img
                src={post.image}
                alt={post.title}
                className="w-full h-[300px] md:h-[400px] object-cover mb-6 rounded-lg"
              />
              ...
              <h2 className="text-2xl md:text-3xl font-medium mb-4">{post.title}</h2>
        ...
        {/* Sticky Sidebar */}
        {showSidebar && (
          <div className="w-full md:w-[300px] space-y-8 sticky top-[100px] h-fit blog-sidebar">
            {/* Search */}
      ...
      <div className="flex justify-center gap-5 pt-8 flex-wrap">
      ...
      <div className="max-w-[1440px] content-center mx-auto px-4 sm:px-8 md:px-16 lg:px-28">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-24 ">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-base sm:text-lg">High Quality</h3>
              <p className="text-[#898989] text-sm sm:text-base">crafted from top materials</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-base sm:text-lg">Warranty Protection</h3>
              <p className="text-[#898989] text-sm sm:text-base">Over 2 years</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[#898989] text-sm sm:text-base">Order over 150 $</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[#898989] text-sm sm:text-base">Dedicated support</p>
            </div>
          </div>
        </div>
      </div>
