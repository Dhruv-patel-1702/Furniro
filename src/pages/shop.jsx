  ...
  return (
    <div className="w-full overflow-hidden">
      ...
      <div className="w-full bg-[#FAF3EA] py-8 md:py-12 ">
        <div className="flex justify-center items-center max-w-[1440px] mx-auto px-4 md:px-8 lg:px-16 ">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-28">
            {/* High Quality */}
