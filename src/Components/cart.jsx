      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-20 py-16">
        <div className="flex flex-col sm:flex-row gap-12">
          ...
          <div className="flex-1">
            ...
            {/* Cart Items */}
              {cartItems.map((item) => (
                <div key={item.productId} className="grid grid-cols-2 sm:grid-cols-5 gap-4 p-4 border-b items-center">
                  <div className="col-span-2 flex gap-4 items-center">
                    <img 
                      src={item.productImage[0]} 
                      alt={item.productName} 
                      className="w-[80px] h-[80px] sm:w-[105px] sm:h-[105px] object-cover" 
                    />
