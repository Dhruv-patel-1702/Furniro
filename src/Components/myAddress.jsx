      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 '>
        {Array.isArray(addresses) && addresses.length > 0 ? (
          addresses.map((address) => (
            <div key={address._id} className={`bg-white p-6 rounded-lg shadow-md border hover:shadow-lg transition-shadow ${
              selectedAddress === address._id ? 'bg-[#B88E2F]/10' : ''
            }`}>
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div className='flex-1'>
                    ...
                    <div className='space-y-2 text-gray-600'>
                      <p>Address : {`${address.addressLine1}${address.addressLine2 ? `, ${address.addressLine2}` : ''}`}</p>
